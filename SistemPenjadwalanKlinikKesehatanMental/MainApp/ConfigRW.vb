...
Public Class ConfigRW
    ...
    Public Sub New()
        _ServerAddress = "DESKTOP-3LSRDEG"
        _DBInstance = "SQLEXPRESS"
        _DBName = "ProyekPCS"
        _UserDB = "kutubuku"
        _PassDb = "12345"
        'ReadConfig() >> dipakek nanti kalo udah mau bikin Pengaturan
    End Sub
    ...
    Sub WriteConfig(ByVal ServerAddress As String, ByVal DBInstance As String, ByVal DBName As String,
                    ByVal DBUser As String, ByVal DBPass As String)
        Try
